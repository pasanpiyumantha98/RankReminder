...
<div class=" grid grid-cols-1  sm:grid-cols-2">
    ...
    <div>
        ...
        <form class="mt-10" >
            ...
            <button type="submit" class="text-white bg-black hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-100 sm:w-auto px-5 py-2.5 text-center mx-10">Login to your account</button>
        </form>
